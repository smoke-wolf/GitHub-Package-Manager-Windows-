...
def GUI():
    ...
    import os, subprocess; [os.system(f"taskkill /pid {int(line.split()[1])} /f") for line in subprocess.check_output(['tasklist', '/fi', 'imagename eq cmd.exe']).decode().splitlines() if 'cmd.exe' in line]
